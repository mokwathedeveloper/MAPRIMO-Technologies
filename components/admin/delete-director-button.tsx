...
import { deleteDirector } from "@/lib/actions/portfolio";
import { toast } from "sonner";

interface DeleteDirectorButtonProps {
  id: string;
  name: string;
  onDelete?: (id: string) => void;
}

export function DeleteDirectorButton({ id, name, onDelete }: DeleteDirectorButtonProps) {
      ...
      <DialogContent>
        ...
        <DialogFooter>
          ...
          <Button variant="destructive" onClick={handleDelete} disabled={loading}>
            {loading ? "Deleting..." : "Delete Director"}
          </Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
