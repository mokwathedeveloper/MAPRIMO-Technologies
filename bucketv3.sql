-- MAPRIMO Technologies - Master System Schema (v3)
...
-- Note: If you have an old project-linked table, you may need to drop it first
...
-- ==========================================
-- STORAGE REINFORCEMENT (Manual Step)
-- ==========================================
-- Ensure you have a public bucket named 'projects' in Supabase Storage.
